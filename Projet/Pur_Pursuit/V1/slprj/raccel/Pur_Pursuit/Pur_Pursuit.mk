###########################################################################
## Makefile generated for component 'Pur_Pursuit'. 
## 
## Makefile     : Pur_Pursuit.mk
## Generated on : Sun Oct 09 02:32:06 2022
## Final product: ./Pur_Pursuit.exe
...
PRODUCT_NAME              = Pur_Pursuit
MAKEFILE                  = Pur_Pursuit.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/leonj/OneDrive/Documents/ETS/Cours/SYS802/Projet/Pur_Pursuit/V1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Pur_Pursuit_comp.rsp
CMD_FILE                  = Pur_Pursuit.rsp
...
DEFINES_STANDARD = -DMODEL=Pur_Pursuit -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO
...
%.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Pur_Pursuit.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/Pur_Pursuit.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pur_Pursuit_capi.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/Pur_Pursuit_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pur_Pursuit_data.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/Pur_Pursuit_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pur_Pursuit_tgtconn.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/Pur_Pursuit_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/Pur_Pursuit/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
